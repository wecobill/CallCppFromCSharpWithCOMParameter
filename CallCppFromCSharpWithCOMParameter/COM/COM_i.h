...
#ifndef __IProcessingPlugins_FWD_DEFINED__
#define __IProcessingPlugins_FWD_DEFINED__
typedef interface IProcessingPlugins IProcessingPlugins;

#endif 	/* __IProcessingPlugins_FWD_DEFINED__ */
...
#ifndef __ProcessingPlugins_FWD_DEFINED__
#define __ProcessingPlugins_FWD_DEFINED__

#ifdef __cplusplus
typedef class ProcessingPlugins ProcessingPlugins;
#else
typedef struct ProcessingPlugins ProcessingPlugins;
#endif /* __cplusplus */

#endif 	/* __ProcessingPlugins_FWD_DEFINED__ */
...
#ifndef __IProcessingPlugins_INTERFACE_DEFINED__
#define __IProcessingPlugins_INTERFACE_DEFINED__

/* interface IProcessingPlugins */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IProcessingPlugins;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("94183CED-A9FC-4E26-8358-45408FBF2115")
    IProcessingPlugins : public IDispatch
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE Initialize( 
            IDispatch *piDoWork) = 0;
        
        virtual HRESULT STDMETHODCALLTYPE ProcessFlaw( void) = 0;
    ...
    typedef struct IProcessingPluginsVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            IProcessingPlugins * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE *ProcessFlaw )( 
            IProcessingPlugins * This);
        
        END_INTERFACE
    } IProcessingPluginsVtbl;

    interface IProcessingPlugins
    {
        CONST_VTBL struct IProcessingPluginsVtbl *lpVtbl;
    };
...
#define IProcessingPlugins_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IProcessingPlugins_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IProcessingPlugins_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IProcessingPlugins_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IProcessingPlugins_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IProcessingPlugins_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IProcessingPlugins_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IProcessingPlugins_Initialize(This,piDoWork)	\
    ( (This)->lpVtbl -> Initialize(This,piDoWork) ) 

#define IProcessingPlugins_ProcessFlaw(This)	\
    ( (This)->lpVtbl -> ProcessFlaw(This) ) 
...
#endif 	/* __IProcessingPlugins_INTERFACE_DEFINED__ */
...
EXTERN_C const CLSID CLSID_ProcessingPlugins;
